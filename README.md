...
* For the evaluation on InterHand2.6M dataset, please download [this](https://drive.google.com/file/d/1NAHOXCccRKENuo2EuortuJuDZ05pZc1z/view?usp=share_link) and place it in `data/InterHand26M` folder. We evaluated all methods on `human_annot` subset of InterHand2.6M dataset.
