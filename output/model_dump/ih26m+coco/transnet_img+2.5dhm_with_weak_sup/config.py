...
class Config:
    ...
    input_hm_shape = (32, 32, 32) #(64, 64, 64)
    ...
    princpt_union = (input_hand_shape[1]/2, input_hand_shape[0]/2) # virtual principal point position of hand bbox union
    bbox_3d_size = 0.3
    camera_3d_size = 0.6
    ...
    model_dir = osp.join(output_dir, 'model_dump', 'transnet_img+2.5dhm_with_weak_sup')
