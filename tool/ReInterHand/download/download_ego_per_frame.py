...
name_list = {
        ...
        'm--20220628--1327--BKS383--pilot--ProjectGoliath--ContinuousHandsy--two-hands': ['aa', 'ab', 'ac', 'ad', 'ae', 'af', 'ag', 'ah', 'ai', 'aj'],
        ...
        'm--20230317--1130--QZX685--pilot--ProjectGoliath--Hands--two-hands': ['aa', 'ab', 'ac', 'ad', 'ae', 'af', 'ag', 'ah', 'ai', 'aj', 'ak', 'al'],
        'm--20230317--1433--TRO760--pilot--ProjectGoliath--Hands--two-hands': ['aa', 'ab', 'ac', 'ad', 'ae', 'af', 'ag', 'ah', 'ai', 'aj', 'ak', 'al']
}
...
def download(capture_id):
    ...
    for name in name_list[capture_id]:
        cmd = 'wget https://fb-baas-f32eacb9-8abb-11eb-b2b8-4857dd089e15.s3.amazonaws.com/ReInterHand/' + capture_id + '/Ego_cameras/envmap_per_frame.tar.gz' + name
        os.system(cmd)
