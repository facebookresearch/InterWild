...
name_list = {
        'm--20210701--1058--0000000--pilot--relightablehandsy--participant0--two-hands': ['aa', 'ab', 'ac', 'ad'],
        'm--20220628--1327--BKS383--pilot--ProjectGoliath--ContinuousHandsy--two-hands': ['aa', 'ab'],
        'm--20221007--1215--HIR112--pilot--ProjectGoliathScript--Hands--two-hands': ['aa', 'ab', 'ac', 'ad', 'ae'],
        'm--20221110--1033--TQH976--pilot--ProjectGoliathScript--Hands--two-hands': ['aa', 'ab'],
        'm--20221111--0944--JFQ550--pilot--ProjectGoliathScript--Hands--two-hands': ['aa', 'ab'],
        'm--20221215--0949--RNS217--pilot--ProjectGoliathScript--Hands--two-hands': ['aa', 'ab'],
        'm--20221216--0953--NKC880--pilot--ProjectGoliathScript--Hands--two-hands': ['aa', 'ab'],
        'm--20230313--1433--TXB805--pilot--ProjectGoliath--Hands--two-hands': ['aa', 'ab', 'ac'],
        'm--20230317--1130--QZX685--pilot--ProjectGoliath--Hands--two-hands': ['aa', 'ab', 'ac'],
...
def download(capture_id):
    ...
    os.chdir(osp.join(current_path, capture_id, 'orig_fits'))

    # download
    for name in name_list[capture_id]:
        cmd = 'wget https://fb-baas-f32eacb9-8abb-11eb-b2b8-4857dd089e15.s3.amazonaws.com/ReInterHand/' + capture_id + '/orig_fits/orig_fits.tar.gz' + name
        os.system(cmd)

    # decompress
    cmd = 'cat orig_fits.tar.gz* | tar zxvf -'
    os.system(cmd)
